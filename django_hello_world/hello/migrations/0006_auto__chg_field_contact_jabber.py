...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.jabber'
        db.alter_column(u'hello_contact', 'jabber', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Contact.jabber'
        db.alter_column(u'hello_contact', 'jabber', self.gf('django.db.models.fields.CharField')(max_length=100))
